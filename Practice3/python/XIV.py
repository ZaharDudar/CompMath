...
ax[0][0].set_ylim((-0.5, np.max(data)))
ax[0][1].set_ylim((-0.5, np.max(data1)))
ax[0][2].set_ylim((-0.5, np.max(data2)))
ax[1][0].set_ylim((-0.5, np.max(data3)))
ax[1][1].set_ylim((-0.5, np.max(data4)))
ax[1][2].set_ylim((-0.5, np.max(data5)))
